...
exports.BING_SPEECH_ENDPOINT = 'https://speech.platform.bing.com/recognize?language=zh-CN';
const GLOBAL_APP_ID = '31b3d95b-af74-4550-9619-de76fe33f0f0';
const RECOGNIZE_DEFAULTS = { locale: 'zh-CN', scenarios: 'ulm', sampleRate: 16000 };
class SpeechClient {
    ...
    requestTextFromSpeech(buf, token, options, callback) {
        console.log('speech client requestTextFromSpeech buf\n', buf);
        console.log('speech client requestTextFromSpeech tokens:\n', `Bearer ${token}`);
        console.log('speech client requestTextFromSpeech options\n', options);
        this.request.post('', {
            body: buf,
            headers: {
    ...
    receiveTextFromSpeech(resp, body, callback) {
        ...
        console.log('speech client receiveTextFromSpeech\n', speech);
